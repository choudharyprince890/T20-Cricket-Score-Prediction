...
from src.components.data_transformation import DataTransformationing

from src.components.model_training import ModelTraningConfig
...
class DataIngestion:
    ...
    def initiated_data_ingestion(self):
        ...
        try:
            data = pd.read_csv(os.path.join("notebook", "data_file.csv"))
...
if __name__=="__main__":
    ...
    print(model_trainer.initatied_model_traning(train_arr,test_arr))